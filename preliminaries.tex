...
\end{lstlisting}
\end{minipage}
\pp{Por qué tiene puntos suspensivos el driver de la figura? Omite métodos? El
Caption dice que no. Además queda cortado el listing, hay que arreglarlo para
que quede en una página.}
\cacho{Hecho, agregue uno mas al final, como es el ultimo pero saque el todos del caption. SOn 60, coincide con la parte de exp}
