...
Randoop es una herramienta de generación automática de pruebas que utiliza la técnica de generación aleatoria para explorar el espacio de entrada de un programa y generar casos de prueba automáticamente. Fue desarrollada por Pacheco y Ernst en la Universidad de Washington \cite{Pacheco:07}.
