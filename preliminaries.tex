...
entonces son enteros entre 0 y b-1}. Así, las entradas generadas por el
...
métodos de la API (línea 4 \pp{la condición está mal, debería ser $0 <= i <=
...
Este driver simple incluye todos los métodos de la API para la generación de
estructuras. Notar que el número de ejecuciones del driver crece exponencialmente con la cantidad de
métodos disponibles. Sin embargo, muchas de estos métodos no son necesarios si
