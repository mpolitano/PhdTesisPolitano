...
como listas doblemente enlazadas) la construcción suele requerir varios métodos de la API (ejemplo, \texttt{add},
\texttt{remove}, etc.), por lo que el diseño del \emph{driver} depende de dichos métodos.
...
usar todos los métodos del módulo, como se muestra en el algortimo \ref{lst:driverAPI}. En el
