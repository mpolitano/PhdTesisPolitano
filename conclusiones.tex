...
La segunda técnica, presentada en el capitulo \ref{cap:beapi}, se centra en la generación exhaustiva acotada de entradas de prueba a partir de la API pública del software bajo prueba (SUT).
