...
5.5}
\cacho{Falta completar aca, no hice nada aun}
...
Cuando un objeto es visitado por primera vez, se le asigna un nuevo identificador (líneas 10--11), y se crea una secuencia singleton 
...
de los campos que deben ser ignorados durante la linealización (véase Sección~\ref{sec:finitization-definition}). Para omitir estos 
