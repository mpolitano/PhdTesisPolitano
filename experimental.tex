...
objetivo, \textbf{\tiny GE} (generación exhaustiva) y \textbf{\tiny RC} (cobertura con Randoop). 
...
En relación con las funciones \emph{objetivo}, observamos que la basada en
