...
Para comparar la eficiencia de \textbf{GA} y \textbf{HC} de manera justa, fijamos la
...
siendo \emph{HashSet} la única excepción donde GA+RC fue más veloz. \cacho{Revisar esto, no me acuerdo bien, ver el paper}
...
% Ademas, comparamos las \emph{suites} generadas midiendo cobertura de ramas y líneas.
