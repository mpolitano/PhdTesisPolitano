...
Por otra parte, la función objetivo \emph{FRC} tiene la ventaja de que no requiere 
que el usuario provea la definición del scope para la generación exhaustiva acotada. 
Además, \emph{FRC} podría ser más escalable que \emph{FGE} en casos donde
...
Se observan cuatro patrones claros. Primero, \texttf{HC+FRC} encuentra el conjunto
\emph{minimal exacto en 12/12} sujetos. Segundo, \texttf{HC+GE} es exacto en
...
que arreglar Lits, y TreeMap con GA+FRC que da demasiado horrible}.
...
\pp{Viendo los números de eficiencia los únicos algoritmos que importan son
HC+FGE y GE+FGE. Los algoritmos de Randoop dan mal en tiempos, y por más que den
bien acá les hace falta laburo. }
