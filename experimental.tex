...
\cacho{Cambie aca}
A nivel de casos
individuales, \texttt{HC} supera a \texttt{GA} en todos los casos tanto con \texttt{FGE} y con \emph{FRC}
...
En promedio para todos los presupuestos, \texttt{R-Serialize-MGO} genera 1347505 objetos 
frente a 880601 de \texttt{R-Serialize-API}. Es decir, el uso de métodos generadores resulta
...
Con un presupuesto de \textbf{120 segundos}, se generan aproximadamente 1.5 
...
generadores se construyen casi 1.37 veces más objetos con los \texttt{MGO} en
comparación con la \texttt{API}. Esta diferencias es debido a que, al aumentar el presupuesto, Randoop tiene más tiempo para explorar la API completa y generar más objetos,
