...
\begin{itemize}
    \item \textbf{FGE}: función objetivo basada en generación exhaustiva
    acotada, presentada en la Sección~\ref{sec:fitnessGE}).
\item \textbf{FRC}: función objetivo basada en la cobertura, descrita en la Sección~\ref{sec:fitnessRandoop}. 
\end{itemize}
