...
literales desde DIMACS a la representación interna.}
...
\cacho{NUEVO:}
El objetivo de esta sección es identificar automáticamente el subconjunto de métodos generadores de cada API (\emph{MGO}). 
...
clase \texttt{TreeMap}. 
En este caso, \texttt{R-Builders} obtiene más mutación que \textbf{BEAPI} (152 vs 140), es decir, mata, aproximadamente un 8\% mas de mutantes;
en cambio, \texttt{BEAPI} logra mayor cobertura de ramas en todos los presupuestos (alrededor del 8\% más).
