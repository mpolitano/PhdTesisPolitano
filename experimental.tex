...
generalmente más eficiente que \textbf{GA} (en promedio y en peor caso) para
...
basada en cobertura con Randoop (\textbf{RC}, Sección~\ref{sec:fitnessRandoop}).
...
para cada candidato considerado.
 \pp{Sin embargo, la función objetivo basada en el algoritmo XX no requiere que el usuario provea la definición del scope, y
