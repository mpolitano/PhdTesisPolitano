...
Como se observa en la tabla, el algoritmo Hill Climbing (\emph{HC}) es más efectivo que el algoritmo genético (\emph{GA}) para calcular los constructores de m\'etodos en todos los casos de estudio considerados.
...
En relaci\'on con las funciones de valoraci\'on, observamos que la función de valoración basada en el generador exhaustivo (GE) logra 
