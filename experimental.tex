...
\cacho{Para observar la ganancia de los objectos, se mide en la seccion XXX, donde consideramos no solo la tecnica de randoop y randoop con builder sino que consideramos veapi y randoop tradicional}
\pp{Falta lo de size}
\cacho{Agregar table, URGENTE!. escribir esa parte}
