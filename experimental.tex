...
\cacho{Lo cambiené un poco pero no sé si está bien:}
...
En cambio, \texttt{HC} \pp{Hay que poner en typewriter la fuente de los algoritmos
y casos de estudio en todo el texto. emph no se usa para eso, sino para resaltar
palabras, y poner palabras en inglés} \cacho{Hecho} sigue una estrategia \emph{greedy}: elige la mejor opción posible entre los sucesores del candidato actual. Esto lo vuelve más eficiente.
...
relativamente pequeño (scope 5). Además, \texttt{FGE} utiliza BEAPI (ver
...
Todas \pp{Ambas funciones?} tienen un \texttt{timeout} de 
...
\cacho{Agregar table, URGENTE!. Esta en las tablas, agregar y escribir esa parte}
