...
Ingeniería de Software. Es por esto que se han desarrollado numerosas técnicas 
automáticas de análisis de software, para asistir a los
...
análisis, como por ejemplo, el testing, el model checking de software, etc. 
Generar un conjunto diverso de objetos para ejercitar adecuadamente el software 
...
generadores se ejecutan en tiempos
razonables, y encuentran métodos generadores de objetos
...
indican que los métodos generadores de objetos son útiles para la mejorar 
