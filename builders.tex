...
\cacho{Deberia poner con equation a todas las formulas!}\pp{No sé que significa
esto!}
...
ramas. Corregir los números en este párrafo.}.
Con \( M_1 \) se cubrieron 192 líneas y 101 ramas (\(Cob(M_1) = 293\)), mientras
que con \( M_2 \) se cubrieron 175 líneas y 97 ramas (\(Cob(M_2) = 272\)).
