...
Nuevamente, elegimos este operador de selección porque dio los mejores resultados en nuestros experimentos (también probamos otros operadores típicos como selección por ruleta, selección por ranking \cite{Goldberg:1989}.
...
Dado que la evolución se aplica sobre el 60\% de la población total (ver Sección \ref{sec:selection}, comúnmente llamados \emph{offspringSize} en los algoritmos genéticos), esto equivale al:
...
Esto indica que, en promedio, se mutan 50 bits de toda la población por generación
...
En la línea 2 y 3 se define el tamaño de la población que va a ser la descendencia, la misma es definida como un 60\% del tamaño de la población total $N$, 
