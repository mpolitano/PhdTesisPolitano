...
\multicolumn{2}{c}{\tiny \#MGO: 3} &  &   & &   \\
\midrule
\multicolumn{2}{c}{\textbf{Lits}} &  6 & 6 & 6 &  6    \\
...
\multicolumn{2}{c}{\tiny \#MGO: 2} &  &   & &    \\
\midrule
\multicolumn{2}{c}{\textbf{TreeMap}} &  3 & \cellcolor{gray!25}\emph{3.60}  &  3  &  3   \\
...
\caption{Precisión de los algoritmos para encontrar un subconjunto de métodos
