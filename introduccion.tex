...
generadores de objetos (ver Sección \ref{sec:experimentalIdentificacion}), en un benchmark de clases Java con estados complejos 
...
Por último, evaluamos experimentalmente BEAPI (ver Sección \ref{sec:experimentalBeapi}) y mostramos que su eficiencia y escalabilidad son comparables a las del mejor enfoque exhaustivo acotado actual (Korat), sin
...
Adicionalmente, proveemos evidencia preliminar que muestra que los objetos generados por BEAPI 
